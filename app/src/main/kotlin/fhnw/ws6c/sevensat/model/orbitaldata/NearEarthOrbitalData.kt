...
class NearEarthOrbitalData(
  ...
  internal fun calculateSGP4(tSince: Double) {
    synchronized(this) {
      ...
      val xmdf = xmo + xmdot * tSince
      val omgadf = omegao + omgdot * tSince
      val xnoddf = xnodeo + xnodot * tSince
      var omega = omgadf
      var xmp = xmdf
      val tsq = sqr(tSince)
  ...
  private fun calculatePosAndVel(
    ...
    val xinck = xincl + 1.5 * temp[2] * cosio * sinio * cos2u
